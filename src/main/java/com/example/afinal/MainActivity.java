    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        squat_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, squat.class);
                startActivity(intent);
            }
        });
        ...
        plank_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, plank.class);
                startActivity(intent);
            }
        });
        ...
        jumpjack_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, jumpingjacks.class);
                startActivity(intent);
            }
        });
        ...
        lunge_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, lunge.class);
                startActivity(intent);
            }
        });
        ...
        highknees_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, highknee.class);
                startActivity(intent);
            }
        });
        ...
        calfrasiae_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                Intent intent = new Intent(MainActivity.this, calfraise.class);
                startActivity(intent);
            }
        });
    }
