package com.zybooks.workoutstatspage.ui.notifications;
...
import com.zybooks.workoutstatspage.databinding.FragmentNotificationsBinding;
...
public class NotificationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (name == null) {
            ...
            // Display the streak
            TextView streakText = binding.streakText;
    ...
    public void calculateBMI(View view) {
        ...
        if (!heightStr.isEmpty() && !weightStr.isEmpty()) {
            ...
            binding.resultText.setText(String.format("Your BMI is %.2f", bmi));
        }
    }
    ...
    private void updateDayOfWeek() {
        ...
        binding.dayOfWeekText.setText("Today is " + days[day - 1]);
    }
